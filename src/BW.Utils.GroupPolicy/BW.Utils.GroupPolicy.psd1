#
# Module manifest for module 'BW.Utils.GroupPolicy'
#
...
ModuleVersion = '21.7.16.1501'

# Supported PSEditions
# CompatiblePSEditions = @()

# ID used to uniquely identify this module
GUID = 'e7ddf053-f620-43b2-9eeb-d9f8ed574cd8'
...
Copyright = '(c) Shannon Graybrook'

# Description of the functionality provided by this module
Description = 'Generic group policy utilities to supplement the official GroupPolicy module'
